...
{
	u32 eax, ebx, ecx, edx;
	printk(KERN_WARNING "\n hello there I am in kvm emulate cpuid\n");
	pr_err("REMOVE ME: hello there Inside kvm emulate cpuid\n");
	...
	if (eax == 0x4FFFFFFF) {
		...
		printk(KERN_WARNING "\n hello thy set new value for eax - exit counter: %u\n", eax);
		kvm_register_write(vcpu, VCPU_REGS_RBX, ebx);
		kvm_register_write(vcpu, VCPU_REGS_RCX, ecx);
		//TODO: Preethi: update ebx, ecx with the exit processing time
		//TODO: Preethi: check what does kvm_cpuid does, do we need to call that function if the leaf is 0x4FFFFFFF
		// kvm_cpuid(vcpu, &eax, &ebx, &ecx, &edx, true);
		kvm_register_write(vcpu, VCPU_REGS_RAX, eax);
		printk(KERN_WARNING "\n hello there I am in dmesg eax == 0x4FFFFFFF\n");
